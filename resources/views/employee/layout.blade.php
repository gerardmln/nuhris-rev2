...
<body class="min-h-screen bg-[#eceef1] text-slate-900 antialiased overflow-x-hidden overflow-y-auto">
    @php
        ...
        $navItems = [
            ...
            ['label' => 'WFH Monitoring', 'route' => 'employee.wfh-monitoring.index', 'match' => 'employee.wfh-monitoring*', 'icon' => 'M4 7h16M4 12h16M4 17h10M7 3v18'],
            ...
            ['label' => 'Download APK', 'href' => 'https://nationalueduph-my.sharepoint.com/:u:/g/personal/malaluangl_students_nu-lipa_edu_ph/IQC8i79zoy1uR60amyqgeImRAcqfHE_GsBvxTpu535vX1o8?e=QUm6so', 'match' => '__never__', 'icon' => 'M4 16v1a2 2 0 002 2h12a2 2 0 002-2v-1M12 4v10m0 0l-4-4m4 4l4-4'],
        ];
    @endphp
