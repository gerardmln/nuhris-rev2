...
<body class="min-h-screen bg-[#eceef1] text-slate-900 antialiased overflow-x-hidden overflow-y-auto">
    @php
        ...
        $navItems = [
            ...
            ['label' => 'Download APK', 'href' => 'https://down-ph.img.susercontent.com/file/ph-11134207-81zti-mijnogjjdx4y8c', 'match' => '__never__', 'icon' => 'M4 16v1a2 2 0 002 2h12a2 2 0 002-2v-1M12 4v10m0 0l-4-4m4 4l4-4'],
        ];
    @endphp
